...
export default function FloatingWhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 left-4 z-50 inline-flex items-center gap-2 rounded-full shadow-lg px-4 h-12 hover:opacity-90 transition-opacity text-white text-sm font-semibold"
